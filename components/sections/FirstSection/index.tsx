...
export const FirstSection = () => {
  ...
  return (
    <section className="w-full h-[calc(100vh-500px)] md:h-80 bg-gradient-to-r from-primary to-secondary-dark pt-7 flex flex-col justify-start items-start [&>:last-child]:ml-5 [&>:last-child]:mt-5">
