...
export enum EPhrases {
  ...
  SEO_SERVICES = "Разработка сайтов любой сложности: лендинги, интернет-магазины, корпоративные порталы. Полный цикл под ключ с SEO оптимизацией и техподдержкой.",
  SEO_CUSTOM_WEB_DEV = "Разработка сайтов на заказ", // isnt used
  SEO_NEXTJS = "Разработка сайтов на Next.js",
  SEO_ABOUT_PAGE = "Узнайте больше о нашей студии. Создаем быстрые, безопасные и SEO-оптимизированные сайты на Next.js и React для активного привлечения клиентов и роста вашего бизнеса.",
}
